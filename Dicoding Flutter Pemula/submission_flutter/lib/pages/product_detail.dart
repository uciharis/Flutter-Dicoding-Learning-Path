...
import 'package:submission_flutter/theme/colors.dart';
import 'package:submission_flutter/widgets/product_slider.dart';
...
class ProductDetailPage extends StatefulWidget {
  ...
  const ProductDetailPage(
      {Key key, this.images, this.name, this.price, this.description})
      : super(key: key);
  @override
